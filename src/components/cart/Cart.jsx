...
const Cart = () => {
    ...
    return (
        <div className="lg:px-14 sm:px-8 px-4 py-10">
            ...
            <div className="grid md:grid-cols-5 grid-cols-4 gap-4 pb-2 semibold center">
                <div className="md:col-span-2 justify-self-start text-lg text-slate-800 lg:ps-4 font-bold">
                    Product
                </div>

                <div className="justify-self-center text-lg text-slate-800 font-bold">
                    Price
                </div>
